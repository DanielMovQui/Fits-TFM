  ...
  return Amp * integral;
    ...
    double BWModificada(double *x, double *par, int l, int bw_index) {
      ...
      // Definir los rangos de energía para cada Breit-Wigner (E_min y E_max)
        static const double E_min_values[14] = {8.67, 8.67, 8.67, 8.67, 8.67, 8.67, 8.67, 8.67, 8.67, 8.67, 8.67, 8.67, 8.67, 8.67};  // Energías mínimas
        static const double E_max_values[14] = {14.5, 14.5, 14.5, 14.5, 14.5, 14.5, 14.5, 14.5, 14.5, 14.5, 14.5, 14.5, 14.5, 14.5};  // Energías máximas
      
        if (bw_index < 0 || bw_index >=14){
            return 0.0;
        }
        ...
        int bin_index_bw = (E - E_min_values[bw_index]) / 0.000583;
        ...
        double E_bin = E_min_values[bw_index] + (bin_index_bw + 0.5) * 0.000583;
        ...
        if (E_bin >= 8.67) {
            ...
            double E_pen_l0 = -Gamma0 * ((T0_values_alpha[bin_index_pen]-T0_values_alpha[bin_index_E0])/(2*T0_values_alpha[bin_index_E0]));
            double E_pen_l1 = -Gamma0 * ((T1_values_alpha[bin_index_pen]-T1_values_alpha[bin_index_E0])/(2*T1_values_alpha[bin_index_E0]));
            double E_pen_l2 = -Gamma0 * ((T2_values_alpha[bin_index_pen]-T2_values_alpha[bin_index_E0])/(2*T2_values_alpha[bin_index_E0]));
            double E_pen_l3 = -Gamma0 * ((T3_values_alpha[bin_index_pen]-T3_values_alpha[bin_index_E0])/(2*T3_values_alpha[bin_index_E0]));
            double E_pen_l4 = -Gamma0 * ((T4_values_alpha[bin_index_pen]-T4_values_alpha[bin_index_E0])/(2*T4_values_alpha[bin_index_E0]));
            double E_pen_l5 = -Gamma0 * ((T5_values_alpha[bin_index_pen]-T5_values_alpha[bin_index_E0])/(2*T5_values_alpha[bin_index_E0]));
            ...
            switch (l) {
                ...
                default:
                    Gamma_eff = Gamma0;
                    // Puedes decidir qué hacer con E_eff aquí también
                    break;
            }
...
void readData_BW_alpha_convolution_shiftfactor()
{
...
exTotalH->Fill(Ex);
 ...
 TCanvas *c1 = new TCanvas("c1", "Plot alpha", 800, 600);
 c1->cd();
...
TF1 *bw9 = new TF1("bw9", [=](double *x, double *par) { 
  return BWModificada(x, par, 0, 8); 
}, 8.67, 14.5, 4);

TF1 *bw10 = new TF1("bw10", [=](double *x, double *par) { 
    return BWModificada(x, par, 1, 9); 
}, 8.67, 14.5, 4);

TF1 *bw11 = new TF1("bw11", [=](double *x, double *par) { 
    return BWModificada(x, par, 2, 10); 
}, 8.67, 14.5, 4);

TF1 *bw12 = new TF1("bw12", [=](double *x, double *par) { 
    return BWModificada(x, par, 1, 11); 
}, 8.67, 14.5, 4);

TF1 *bw13 = new TF1("bw13", [=](double *x, double *par) { 
    return BWModificada(x, par, 0, 12); 
}, 8.67, 14.5, 4);

TF1 *bw14 = new TF1("bw14", [=](double *x, double *par) { 
    return BWModificada(x, par, 0, 13); 
}, 8.67, 14.5, 4);

// Definir parámetros iniciales para cada Breit-Wigner
bw1->SetParameters(300, 8.95, 0.2, 0.0657);
bw2->SetParameters(300, 9.18, 0.2, 0.0657);
bw3->SetParameters(300, 9.27, 0.004, 0.0657); 
bw4->SetParameters(300, 9.9, 0.004, 0.0657); 
bw5->SetParameters(300, 10.28, 0.10, 0.0657);
bw6->SetParameters(300, 10.6, 0.2, 0.0657);
bw7->SetParameters(300, 11.2, 0.2, 0.0657);
bw8->SetParameters(300, 11.45, 0.2, 0.0657);
bw9->SetParameters(300, 11.6, 0.2, 0.0657);
bw10->SetParameters(300, 11.84, 0.2, 0.0657);
bw11->SetParameters(300, 12.5, 0.2, 0.0657);
bw12->SetParameters(300, 12.95, 0.2, 0.0657);
bw13->SetParameters(300, 13.2, 0.2, 0.0657);
bw14->SetParameters(300, 13.6, 0.2, 0.0657);
...
exTotalH->Fit(bw5, "RQ0+");
exTotalH->Fit(bw6, "RQ0+");
exTotalH->Fit(bw7, "RQ0+");
exTotalH->Fit(bw8, "RQ0+");
exTotalH->Fit(bw9, "RQ0+");
exTotalH->Fit(bw10, "RQ0+");
exTotalH->Fit(bw11, "RQ0+");
exTotalH->Fit(bw12, "RQ0+");
exTotalH->Fit(bw13, "RQ0+");
exTotalH->Fit(bw14, "RQ0+");
...
total->SetParLimits(1, 8.9, 8.95);
total->SetParLimits(2, 0.025, 0.03);
total->FixParameter(3, 0.0657);
total->SetParLimits(4, 1, 10000);
total->SetParLimits(5, 9.15, 9.2);
total->SetParLimits(6, 0.004, 0.01);
total->FixParameter(7, 0.0657);
total->SetParLimits(8, 1, 1000);
total->SetParLimits(9, 9.31, 9.32);
total->SetParLimits(10, 0.005, 0.012);
total->FixParameter(11, 0.0657);
total->SetParLimits(12, 1, 10000);
total->SetParLimits(13, 9.85, 9.95);
total->SetParLimits(14, 0.09, 0.15);
total->FixParameter(15, 0.0657);
total->SetParLimits(16, 1, 10000);
total->SetParLimits(17, 10.28, 10.38);
total->SetParLimits(18, 0.1, 0.3);
total->FixParameter(19, 0.0657);
total->SetParLimits(20, 1, 10000);
total->SetParLimits(21, 10.6, 10.7);
total->SetParLimits(22, 0.1, 0.3);
total->FixParameter(23, 0.0657);
total->SetParLimits(24, 1, 10000);
total->SetParLimits(25, 11.25, 11.35);
total->SetParLimits(26, 0.1, 0.11);
total->FixParameter(27, 0.0657);
total->SetParLimits(28, 1, 10000);
total->SetParLimits(29, 11.44, 11.46);
total->SetParLimits(30, 0.02, 0.05);
total->FixParameter(31, 0.0657);
total->SetParLimits(32, 1, 10000);
total->SetParLimits(33, 11.66, 11.68);
total->SetParLimits(34, 0.225, 0.275);
total->FixParameter(35, 0.0657);
total->SetParLimits(36, 1, 10000);
total->SetParLimits(37, 11.8, 11.85);
total->SetParLimits(38, 0.172, 0.292);
total->FixParameter(39, 0.0657);
total->SetParLimits(40, 1, 10000);
total->SetParLimits(41, 12.52, 12.57);
total->SetParLimits(42, 0.225, 0.335);
total->FixParameter(43, 0.0657);
total->SetParLimits(44, 1, 10000);
total->SetParLimits(45, 12.84, 12.96);
total->SetParLimits(46, 0.200, 0.300);
total->FixParameter(47, 0.0657);
total->SetParLimits(48, 1, 10000);
total->SetParLimits(49, 13.21, 13.25);
total->SetParLimits(50, 0.200, 0.300);
total->FixParameter(51, 0.0657);
total->SetParLimits(52, 1, 10000);
total->SetParLimits(53, 13.6, 13.62);
total->SetParLimits(54, 0.2, 0.250);
...
TF1 *new_bw5 = new TF1("new_bw5", [=](double *x, double *par_total) { 
    return BWModificada(x, par_total, 1, 4); 
}, 8.67, 14.5, 4);
...
/*
// Calculate FWHM for each BWModificada + convolution function
double fwhm1 = calculateFWHM(new_bw1, par_total[1], 8.67, 14.5);
double fwhm2 = calculateFWHM(new_bw2, par_total[5], 8.67, 14.5);
double fwhm3 = calculateFWHM(new_bw3, par_total[9], 8.67, 14.5);
double fwhm4 = calculateFWHM(new_bw4, par_total[13], 8.67, 14.5);
double fwhm5 = calculateFWHM(new_bw5, par_total[17], 8.67, 14.5);
double fwhm6 = calculateFWHM(new_bw6, par_total[21], 8.67, 14.5);
double fwhm7 = calculateFWHM(new_bw7, par_total[25], 8.67, 14.5);
double fwhm8 = calculateFWHM(new_bw8, par_total[29], 8.67, 14.5);
double fwhm9 = calculateFWHM(new_bw9, par_total[33], 8.67, 14.5);
double fwhm10 = calculateFWHM(new_bw10, par_total[37], 8.67, 14.5);
double fwhm11 = calculateFWHM(new_bw11, par_total[41], 8.67, 14.5);
double fwhm12 = calculateFWHM(new_bw12, par_total[45], 8.67, 14.5);
double fwhm13 = calculateFWHM(new_bw13, par_total[49], 8.67, 14.5);
double fwhm14 = calculateFWHM(new_bw14, par_total[53], 8.67, 14.5);


// Print the FWHM values
std::cout << "FWHM for BW1 convoluted: " << fwhm1 << std::endl;
std::cout << "FWHM for BW2 convoluted: " << fwhm2 << std::endl;
std::cout << "FWHM for BW3 convoluted: " << fwhm3 << std::endl;
std::cout << "FWHM for BW4 convoluted: " << fwhm4 << std::endl;
std::cout << "FWHM for BW5 convoluted: " << fwhm5 << std::endl;
std::cout << "FWHM for BW6 convoluted: " << fwhm6 << std::endl;
std::cout << "FWHM for BW7 convoluted: " << fwhm7 << std::endl;
std::cout << "FWHM for BW8 convoluted: " << fwhm8 << std::endl;
std::cout << "FWHM for BW9 convoluted: " << fwhm9 << std::endl;
std::cout << "FWHM for BW10 convoluted: " << fwhm10 << std::endl;
std::cout << "FWHM for BW11 convoluted: " << fwhm11 << std::endl;
std::cout << "FWHM for BW12 convoluted: " << fwhm12 << std::endl;
std::cout << "FWHM for BW13 convoluted: " << fwhm13 << std::endl;
std::cout << "FWHM for BW14 convoluted: " << fwhm14 << std::endl;
*/
...
Double_t integral_bw1 = new_bw1->Integral(8.67, 14.5) * 15;
Double_t integral_bw2 = new_bw2->Integral(8.67, 14.5) * 15;
Double_t integral_bw3 = new_bw3->Integral(8.67, 14.5) * 15;
Double_t integral_bw4 = new_bw4->Integral(8.67, 14.5) * 15;
Double_t integral_bw5 = new_bw5->Integral(8.67, 14.5) * 15;
Double_t integral_bw6 = new_bw6->Integral(8.67, 14.5) * 15;
Double_t integral_bw7 = new_bw7->Integral(8.67, 14.5) * 15;
Double_t integral_bw8 = new_bw8->Integral(8.67, 14.5) * 15;
Double_t integral_bw9 = new_bw9->Integral(8.67, 14.5) * 15;
Double_t integral_bw10 = new_bw10->Integral(8.67, 14.5) * 15;
Double_t integral_bw11 = new_bw11->Integral(8.67, 14.5) * 15;
Double_t integral_bw12 = new_bw12->Integral(8.67, 14.5) * 15;
Double_t integral_bw13 = new_bw13->Integral(8.67, 14.5) * 15;
Double_t integral_bw14 = new_bw14->Integral(8.67, 14.5) * 15;
