...
void PhaseSpace_10Bdp11B_binWidth( int Nbin, double MinLim, double MaxLim, double sigma_Ex, double thetaCM_min, double thetaCM_max, double theta_min, double theta_max , double T_min, double T_max ) {
	...
	m1 = 10.012937*931.494;	//Beam mass 10B
	m2 = 2.01410177785*931.494 ;	//Target mass d
	m3 = 1.007276*931.494 ;	//Ejectile mass p
	m4 = 11.009305*931.494;	//Beam-like fragment 11B
	m5 = 10.012937*931.494;	//Beam mass 10B
	mn = 1.008665*931.494;	//Neutron mass
	bE = 0.4;			//Beam energy MeV/A
	T1 = 10.012937*bE;		//Beam kinetic energy middle of target
	...
	TH1F *h_PS = new TH1F("h_PS","Phase Space ^{10}B(d,p)^{11}B;E_{x} (MeV);Counts", Nbin, MinLim, MaxLim ) ;
...
void PhaseSpace_10Bdp11B_test() {
	...
	PhaseSpace_10Bdp11B_binWidth( Nbin, MinLim, MaxLim, sigma_Ex, thetaCM_min, thetaCM_max, theta_min, theta_max, T_min, T_max  ) ;
