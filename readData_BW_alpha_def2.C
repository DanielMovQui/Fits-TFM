...
TF1 *bw17 = new TF1("bw17", [=](double *x, double *par) { 
    return BW(x, par, 16); 
}, 8.5, 14.5, 4);
...
bw2->SetParameters(300, 9.27, 0.004); 
...
bw9->SetParameters(300, 11.84, 0.2);
bw10->SetParameters(300, 12., 0.2);
bw11->SetParameters(300, 12.5, 0.2);
bw12->SetParameters(300, 12.95, 0.2);
bw13->SetParameters(300, 13.2, 0.2);
bw14->SetParameters(300, 13.3, 0.2);
bw15->SetParameters(300, 13.6, 0.2);
bw16->SetParameters(300, 13.8, 0.2);
bw17->SetParameters(300, 14., 0.2);
...
total->SetParLimits(1, 9., 9.40);
total->SetParLimits(2, 0., 0.3);
total->FixParameter(3, 0.0657);
total->SetParLimits(5, 9., 9.40);
...
total->SetParLimits(26, 0.05, 0.16);
...
total->SetParLimits(54, 0.150, 0.190);
...
total->SetParLimits(65, 13.98, 14.02);
total->SetParLimits(66, 0.2, 0.26);
...
new_bw17->SetParameters(par_total+64);
