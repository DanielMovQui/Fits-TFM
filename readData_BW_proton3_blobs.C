...
void readData_BW_proton3_blobs()
{
...
auto cutProtonRecoil1 = new TCutG("cutProtonRecoil1",6);
   ...
   cutProtonRecoil1->SetTitle("Graph");
   cutProtonRecoil1->SetFillStyle(1000);
   cutProtonRecoil1->SetPoint(0,3152.19,1379.15);
   cutProtonRecoil1->SetPoint(1,3236.74,1006.35);
   cutProtonRecoil1->SetPoint(2,3321.29,1071.19);
   cutProtonRecoil1->SetPoint(3,3228.29,1443.98);
   cutProtonRecoil1->SetPoint(4,3160.65,1346.73);
   cutProtonRecoil1->SetPoint(5,3152.19,1379.15);
   cutProtonRecoil1->Draw("");
...
auto cutProtonRecoil2 = new TCutG("cutProtonRecoil2",6);
   ...
   cutProtonRecoil2->SetTitle("Graph");
   cutProtonRecoil2->SetFillStyle(1000);
   cutProtonRecoil2->SetPoint(0,3008.46,1362.94);
   cutProtonRecoil2->SetPoint(1,3101.46,1054.98);
   cutProtonRecoil2->SetPoint(2,3211.38,1119.81);
   cutProtonRecoil2->SetPoint(3,3093.01,1460.19);
   cutProtonRecoil2->SetPoint(4,3008.46,1346.73);
   cutProtonRecoil2->SetPoint(5,3008.46,1362.94);
   cutProtonRecoil2->Draw("");
...
auto cutProtonRecoil3 = new TCutG("cutProtonRecoil3",6);
   ...
   cutProtonRecoil3->SetTitle("Graph");
   cutProtonRecoil3->SetFillStyle(1000);
   cutProtonRecoil3->SetPoint(0,3169.1,1330.52);
   cutProtonRecoil3->SetPoint(1,3253.65,1006.35);
   cutProtonRecoil3->SetPoint(2,3372.02,1103.6);
   cutProtonRecoil3->SetPoint(3,3253.65,1411.57);
   cutProtonRecoil3->SetPoint(4,3169.1,1314.32);
   cutProtonRecoil3->SetPoint(5,3169.1,1330.52);
   cutProtonRecoil3->Draw("");
...
auto cutProtonRecoil4 = new TCutG("cutProtonRecoil4",6);
   ...
   cutProtonRecoil4->SetTitle("Graph");
   cutProtonRecoil4->SetFillStyle(1000);
   cutProtonRecoil4->SetPoint(0,3118.37,1362.94);
   cutProtonRecoil4->SetPoint(1,3211.38,1006.35);
   cutProtonRecoil4->SetPoint(2,3295.93,1103.6);
   cutProtonRecoil4->SetPoint(3,3202.92,1411.57);
   cutProtonRecoil4->SetPoint(4,3118.37,1330.52);
   cutProtonRecoil4->SetPoint(5,3118.37,1362.94);
   cutProtonRecoil4->Draw("");
