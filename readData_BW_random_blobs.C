...
auto cutProtonRecoil1 = new TCutG("cutProtonRecoil1",7);
   ...
   cutProtonRecoil1->SetPoint(0,3481.94,4474.97);
   cutProtonRecoil1->SetPoint(1,4707.93,3583.51);
   cutProtonRecoil1->SetPoint(2,5037.68,3648.34);
   cutProtonRecoil1->SetPoint(3,4589.56,4474.97);
   cutProtonRecoil1->SetPoint(4,3439.66,4766.73);
   cutProtonRecoil1->SetPoint(5,3524.22,4393.93);
   cutProtonRecoil1->SetPoint(6,3481.94,4474.97);
   cutProtonRecoil1->Draw("");

auto cutProtonRecoil2 = new TCutG("cutProtonRecoil2",8);
   cutProtonRecoil2->SetVarX("rdtH[1]");
   cutProtonRecoil2->SetVarY("");
   cutProtonRecoil2->SetTitle("Graph");
   cutProtonRecoil2->SetFillStyle(1000);
   cutProtonRecoil2->SetPoint(0,3270.56,4539.81);
   cutProtonRecoil2->SetPoint(1,4014.61,3923.88);
   cutProtonRecoil2->SetPoint(2,4902.39,3826.63);
   cutProtonRecoil2->SetPoint(3,4259.81,4669.48);
   cutProtonRecoil2->SetPoint(4,3186.01,4750.52);
   cutProtonRecoil2->SetPoint(5,3304.38,4474.97);
   cutProtonRecoil2->SetPoint(6,3304.38,4474.97);
   cutProtonRecoil2->SetPoint(7,3270.56,4539.81);
...
auto cutProtonRecoil3 = new TCutG("cutProtonRecoil3",7);
   ...
   cutProtonRecoil3->SetPoint(0,3532.67,4280.47);
   cutProtonRecoil3->SetPoint(1,4885.48,3356.59);
   cutProtonRecoil3->SetPoint(2,5206.78,3502.46);
   cutProtonRecoil3->SetPoint(3,4589.56,4556.02);
   cutProtonRecoil3->SetPoint(4,3439.66,4604.64);
   cutProtonRecoil3->SetPoint(5,3566.49,4231.85);
   cutProtonRecoil3->SetPoint(6,3532.67,4280.47);
...
auto cutProtonRecoil4 = new TCutG("cutProtonRecoil4",7);
   ...
   cutProtonRecoil4->SetPoint(0,3481.94,4474.97);
   cutProtonRecoil4->SetPoint(1,4707.93,3583.51);
   cutProtonRecoil4->SetPoint(2,5037.68,3648.34);
   cutProtonRecoil4->SetPoint(3,4589.56,4474.97);
   cutProtonRecoil4->SetPoint(4,3439.66,4766.73);
   cutProtonRecoil4->SetPoint(5,3524.22,4393.93);
   cutProtonRecoil4->SetPoint(6,3481.94,4474.97);
