...
const Float_t Recoil_Z_dist_from_target = 60.0; // Distance of the recoil detector with respect to the target
...
TGeoVolume *create_detector()
{
   ...
   // Target
   TGeoVolume *target = gGeoManager->MakeBox("siliconTarget", cd2, 4.0 / 2, 4.0 / 2, 0.0001075 / 2);
