...
double BWModificada(double *x, double *par, int l, int bw_index) {
  static const double E_min_values[5] = {11.23, 11.23, 11.23, 11.23, 11.23};
  static const double E_max_values[5] = {14.5, 14.5, 14.5, 14.5, 14.5};
...
void readData_BW_proton_penetrability_prueba() {
...
double binEfficiency10k[] = {
  1, 1, 0.15, 0.1634, 0.1622, 0.1510, 0.147, 0.1431, 0.137, 0.1317, 0.127, 0.1231, 0.1164, 0.113, 0.1106, 0.1036, 0.097, 0.0938, 0.0900, 0.087, 0.0821, 0.0756};
...
TF1 *bw2 = new TF1("bw2", [=](double *x, double *par) { 
    return BWModificada(x, par, 3, 1); 
}, 11.23, 14.5, 4);

TF1 *bw3 = new TF1("bw3", [=](double *x, double *par) { 
    return BWModificada(x, par, 4, 2); 
}, 11.23, 14.5, 4);
...
bw5->SetParameters(50, 14, 0.2, 0.0657);  

// Definir total dada por la suma de los 16 picos
TF1 *total = new TF1("mstotal", TotalFunction, 11, 14.5, 20);
...
total->SetParLimits(0, 1, 3);
total->SetParLimits(1, 11.48, 11.5);
total->SetParLimits(2, 0.1, 0.13);
total->FixParameter(3, 0.0657);
total->SetParLimits(4, 1, 100);
total->SetParLimits(5, 12.05, 12.15);
total->SetParLimits(6, 0.25, 0.4);
total->FixParameter(7, 0.0657);
total->SetParLimits(8, 1, 100);
total->SetParLimits(9, 12.45, 12.6);
total->SetParLimits(10, 0.4, 0.5);
total->FixParameter(11, 0.0657);
total->SetParLimits(12, 1, 100);
total->SetParLimits(13, 13.357, 13.380);
total->SetParLimits(14, 0.144, 0.5);
total->FixParameter(15, 0.0657);
total->SetParLimits(16, 1, 100);
total->SetParLimits(17, 13.7, 13.9);
...
TF1 *new_bw2 = new TF1("new_bw2", [=](double *x, double *par_total) {
  return BWModificada(x, par_total, 3, 1);
}, 11.23, 14.5, 4);

TF1 *new_bw3 = new TF1("new_bw3", [=](double *x, double *par_total) {
  return BWModificada(x, par_total, 4, 2);
}, 11.23, 14.5, 4);
...
TF1 *new_bw5 = new TF1("new_bw5", [=](double *x, double *par_total) {
  return BWModificada(x, par_total, 2, 4);
}, 11.23, 14.5, 4);
...
Double_t integral_bw1 = new_bw1->Integral(11.23, 14.5) * 15;
Double_t integral_bw2 = new_bw2->Integral(11.23, 14.5) * 15;
Double_t integral_bw3 = new_bw3->Integral(11.23, 14.5) * 15;
Double_t integral_bw4 = new_bw4->Integral(11.23, 14.5) * 15;
Double_t integral_bw5 = new_bw5->Integral(11.23, 14.5) * 15;
...
exTotalH->GetYaxis()->SetRangeUser(0, 200);
