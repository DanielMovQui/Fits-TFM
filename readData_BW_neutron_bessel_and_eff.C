...
double BWModificada(double *x, double *par, int l, int bw_index) {
    ...
    // Definir los rangos de energía para cada Breit-Wigner (E_min y E_max)
        static const double E_min_values[11] = {11.46, 11.46, 11.46, 11.46, 11.46, 11.46, 11.46, 11.46, 11.46, 11.46, 11.46};  // Energías mínimas
        static const double E_max_values[11] = {14.3, 14.3, 14.3, 14.3, 14.3, 14.3, 14.3, 14.3, 14.3, 14.3, 14.3};  // Energías máximas
...
void readData_BW_neutron_bessel_and_eff()
{
